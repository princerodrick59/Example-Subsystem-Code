...
import frc.robot.subsystems.Arm.TalonFX_Arm_CANCoder_MM;

/* You should consider using the more terse Command factories API instead https://docs.wpilib.org/en/stable/docs/software/commandbased/organizing-command-based.html#defining-commands */
public class Arm_Setpoint_CMD extends Command {
  private TalonFX_Arm_CANCoder_MM m_armSubsystem;
   ...
   */
  public Arm_Setpoint_CMD(TalonFX_Arm_CANCoder_MM armSubsystem, double armSetpoint) {
